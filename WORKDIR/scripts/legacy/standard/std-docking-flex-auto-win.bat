...
echo "(1)(b) Make sure the PATH to smina is correct in std-dock_flex_autolist.sh."
echo "(2) Make sure you have all the complex.pdb files you would like to evaluate in the same folder as this script!"
...
bash std-dock_flex_autolist.sh
