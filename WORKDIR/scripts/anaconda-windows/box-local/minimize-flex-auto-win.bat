...
echo "(1)(a) Make sure min_flex_autolist.sh is in the same directory as this program."
echo "(1)(b) Make sure the PATH to smina is correct in min_flex_autolist.sh."
...
echo Assuming a "Just Me" anaconda3 installation...
...
set ENVPATH=%USERPROFILE%\anaconda3\envs\%ENVNAME%

rem Activate the conda environment
call %CONDAPATH%\Scripts\activate.bat %ENVPATH%

rem Run the bash script
bash min_flex_autolist.sh
