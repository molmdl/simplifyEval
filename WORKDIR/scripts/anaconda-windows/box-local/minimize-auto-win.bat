...
echo "(1)(a) Make sure min_autolist.sh is in the same directory as this program."
echo "(1)(b) Make sure the PATH to smina is correct in min_autolist.sh."
